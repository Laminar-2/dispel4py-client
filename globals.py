...
#http://172.24.144.1:8080/registry
...
URL_REMOVE_PE_NAME: str = BASE_URL_REGISTER + "/remove/pe/name/"

URL_REMOVE_PE_ID: str = BASE_URL_REGISTER + "/remove/pe/id/"
...
URL_GET_PE_BY_WORKFLOW_NAME: str = BASE_URL_REGISTER + "/workflow/pes/id/"

URL_GET_PE_BY_WORKFLOW_ID: str = BASE_URL_REGISTER + "/workflow/pes/name/"

URL_REMOVE_WORKFLOW_NAME: str = BASE_URL_REGISTER + "/remove/workflow/name/"

URL_REMOVE_WORKFLOW_ID: str = BASE_URL_REGISTER + "/remove/workflow/id/"
...
PE_TYPES = (BasePE,IterativePE,ProducerPE,ConsumerPE,SimpleFunctionPE,CompositePE)
